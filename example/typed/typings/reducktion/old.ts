declare module 'reducktion' {
  ...
  interface Duck<S, A, SE> {
    ...
    types: Types<A>;
    actions: A;
    selectors: /*{ [K in keyof Pick<SE, any>]: Selector<S> }*/ ReturnType<SE> & {
  ...
  export function createDuck<S, A>(
    df: DuckDefinition<S, A>
  ): Duck<S, A, Pick<DuckDefinition<S, A>, 'selectors'>>;
